...
# Shard the descriptive price join by warehouse source. This keeps the exact same
# grouping population but bounds the hash-join state on hosted runners.
